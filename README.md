...
- **扫描日志** — 统一多数据源扫描记录中心（交换机/vCenter/F5/ZDNS/椒图），支持按数据源和状态筛选、分页、清除、耗时记录
...
├── frontend/
│   ├── src/
│   │   ├── views/               # Login, Dashboard, SwitchList/Detail, VCenterList/Detail, F5List/Detail, ZDNSList/Detail, QAXList/Detail, Results, Routes, SubnetManage, SearchResult, ScanLogs, History, AssetProfile, UserManage, Profile
